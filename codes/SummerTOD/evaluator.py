...
class MultiWozEvaluator(object):
    def __init__(self, reader, logger, eval_data_type="test"):
        self.logger = logger
        self.reader = reader
    ...
    def context_to_response_eval(self, dials, eval_dial_list=None):
        counts = {}
    ...
    def e2e_eval(self, data, eval_dial_list=None):
