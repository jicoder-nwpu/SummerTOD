...
class MultiWOZReader(BaseReader):
    def __init__(self, backbone, version, logger, context_size, type='single'):
        self.logger = logger
    ...
    def get_data_dir(self):
        return os.path.join(
            "data", "MultiWOZ_{}".format(self.version), "{}-ws{}-processed".format(self.type, self.context_size - 1))
