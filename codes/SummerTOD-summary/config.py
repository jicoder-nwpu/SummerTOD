...
def add_config(parser):
    ...
    group.add_argument("-task", type=str, default="e2e",
                       choices=["dst", "e2e"])
    group.add_argument("-context_size", type=int, default=4)
    group.add_argument("-summary_context_size", type=int, default=101)
    group.add_argument("-ururu", action="store_true")
    group.add_argument("-add_summary_cross_attention", action="store_true")
    ...
    group.add_argument("-grad_accum_steps", type=int, default=2)
