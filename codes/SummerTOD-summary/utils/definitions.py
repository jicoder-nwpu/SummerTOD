...
BOS_SUM_TOKEN = "<bos_sum>"
EOS_SUM_TOKEN = "<eos_sum>"

SUM_TOKENS = [BOS_SUM_TOKEN, EOS_SUM_TOKEN]
...
SPECIAL_TOKENS = USER_TOKENS + SUM_TOKENS + BELIEF_TOKENS + DB_TOKENS + ACTION_TOKENS + RESP_TOKENS + DB_STATE_TOKENS
